...
class Player_ranker():
    ...
    def assign_values(self):
        ...
        value_merged['Total_value']=value_merged['value_points']+value_merged['value_rebounds']+value_merged['value_assists']+value_merged['value_blocks']+value_merged['value_steals']+value_merged['value_turnovers']+value_merged['value_threes']+value_merged['value_fg']+value_merged['value_ft']
        self.value = value_merged[['season','player','Total_value','value_points','value_rebounds','value_assists','value_blocks','value_steals','value_turnovers','value_threes','value_fg','value_ft']]