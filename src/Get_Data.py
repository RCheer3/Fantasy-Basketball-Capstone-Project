...
class Get_Category_Data:
    ...
    def __init__(self):
        ...
        point_query = '''select * from points_pred where season>2009'''
        ...
        rebound_query = '''select * from rebounds_pred where season>2009'''
        ...
        rebounds_df['yearspro_squared'] = rebounds_df['yearspro_squared']*rebounds_df['yearspro_squared']
        ...
        assist_query = ''' select * from assists_pred where season>2009'''
        ...
        threes_query = '''select * from threes_pred where season>2009'''
        ...
        turnover_query = '''select * from turnovers_pred where season>2009'''
        ...
        percentages_query = ''' select * from percentages where season>2009'''
    ...
    def get_train_test_split(self, test_proportion=0.3):
        self.y_points = self.points[(self.points['season']!=2017) & (self.points['Games']>30)]['points']
        self.X_points = self.points[(self.points['season']!=2017) & (self.points['Games']>30)].drop(['points','player','season','team','Games'],axis=1)
        ...
        self.X_rebounds = self.rebounds[(self.rebounds['season']!=2017) & (self.rebounds['Games']>30)].drop(['player','team','rebounds','Games'],axis=1)
        self.y_rebounds = self.rebounds[(self.rebounds['season']!=2017) & (self.rebounds['Games']>30)]['rebounds']
        ...
        self.X_assists = self.assists[(self.assists['season']!=2017) & (self.assists['Games']>30)].drop(['player','team','assists','Games'],axis=1)
        self.y_assists = self.assists[(self.assists['season']!=2017) & (self.assists['Games']>30)]['assists']
        ...
        self.X_steals = self.steals[(self.steals['season']!=2017) & (self.steals['Games']>30)].drop(['player','team','steals','Games'],axis=1)
        self.y_steals = self.steals[(self.steals['season']!=2017) & (self.steals['Games']>30)]['steals']
        ...
        self.X_blocks = self.blocks[(self.blocks['season']!=2017) & (self.blocks['Games']>30)].drop(['player','team','blocks','Games'],axis=1)
        self.y_blocks = self.blocks[(self.blocks['season']!=2017) & (self.blocks['Games']>30)]['blocks']
        ...
        self.X_threes = self.threes[(self.threes['season']!=2017) & (self.threes['Games']>30)].drop(['player','team','3PM','Games'],axis=1)
        self.y_threes = self.threes[(self.threes['season']!=2017) & (self.threes['Games']>30)]['3PM']
        ...
        self.X_tos = self.tos[(self.tos['season']!=2017) & (self.tos['Games']>30)].drop(['player','team','turnovers','Games'],axis=1)
        self.y_tos = self.tos[(self.tos['season']!=2017) & (self.tos['Games']>30)]['turnovers']
        self.X_train_tos,self.X_test_tos,self.y_train_tos,self.y_test_tos = train_test_split(self.X_tos,self.y_tos,test_size = 0.3)
        
        self.X_FGM = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)].drop(['player','team','FGM','FGA','FG_percent','FTM','FTA','Games'],axis=1)
        self.y_FGM = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)]['FGM']
        self.X_train_FGM,self.X_test_FGM,self.y_train_FGM,self.y_test_FGM = train_test_split(self.X_FGM,self.y_FGM,test_size = 0.3)
        
        self.X_FTM = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)].drop(['player','team','FTM','FGA','FG_percent','FTM','FTA','Games'],axis=1)
        self.y_FTM = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)]['FTM']
        self.X_train_FTM,self.X_test_FTM,self.y_train_FTM,self.y_test_FTM = train_test_split(self.X_FTM,self.y_FTM,test_size = 0.3)
        
        self.X_FGP = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)][['FG_percent_ly','career_FGpercent','age','age_squared','yearspro','yearspro_squared','max_teammateto','max_teammateshot_attempts','max_teammate_usage','max_teammatepts','usagerank']]
        self.y_FGP = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)]['FG_percent']
        self.X_train_FGP,self.X_test_FGP,self.y_train_FGP,self.y_test_FGP = train_test_split(self.X_FGP,self.y_FGP,test_size = 0.3)
        
        self.X_FTP = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)][['FT_percent_ly','career_FTPercent','age','age_squared','yearspro','yearspro_squared','max_teammateto','max_teammateshot_attempts','max_teammate_usage','max_teammatepts','usagerank']]
        self.y_FTP = self.percentages[(self.percentages['season']!=2017) & (self.percentages['Games']>30)]['FT_percent']
